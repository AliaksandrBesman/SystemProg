#include <iostream>
#pragma comment(lib,"E:\\University\\SP\\LWs\\Lw2_v3\\lab2\\lab10\\Debug\\lib.lib")
#include "../lib/HT.h"
#include "../lib/HT.cpp"
...
int main()
{
	...
	const wchar_t* fileName = L"E:\\University\\SP\\LWs\\Lw2_v3\\lab2\\storage1.ht";
	const wchar_t* fileName2 = L"E:\\University\\SP\\LWs\\Lw2_v3\\lab2\\storage2.ht";
	try {
		...
		HT::Element* el1 = new HT::Element("str", 4, "sysprog", 7);
